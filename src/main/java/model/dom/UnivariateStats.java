...
/**
 * http://www.dmg.org/PMML-4_3:UnivariateStatsElemType interface.
 */
public interface UnivariateStats extends DomElement {
	...
	/**
	 * Returns the value of the DiscrStats child.
	 * @return the value of the DiscrStats child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the ContStats child.
	 * @return the value of the ContStats child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the Anova child.
	 * @return the value of the Anova child.
	 */
	@NotNull
	Anova getAnova();
