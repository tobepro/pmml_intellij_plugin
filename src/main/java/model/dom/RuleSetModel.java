...
/**
 * http://www.dmg.org/PMML-4_3:RuleSetModelElemType interface.
 */
public interface RuleSetModel extends DomElement {
	...
	/**
	 * Returns the value of the RuleSet child.
	 * @return the value of the RuleSet child.
	 */
	@NotNull
	@Required
	RuleSet getRuleSet();
