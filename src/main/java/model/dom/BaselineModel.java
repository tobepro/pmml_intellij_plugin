...
/**
 * http://www.dmg.org/PMML-4_3:BaselineModelElemType interface.
 */
public interface BaselineModel extends DomElement {
	...
	/**
	 * Returns the value of the TestDistributions child.
	 * @return the value of the TestDistributions child.
	 */
	@NotNull
	@Required
	TestDistributions getTestDistributions();
