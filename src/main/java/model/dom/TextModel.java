...
/**
 * http://www.dmg.org/PMML-4_3:TextModelElemType interface.
 */
public interface TextModel extends DomElement {
	...
	/**
	 * Returns the value of the numberOfTerms child.
	 * @return the value of the numberOfTerms child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<Integer> getNumberOfTerms();


	/**
	 * Returns the value of the numberOfDocuments child.
	 * @return the value of the numberOfDocuments child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<Integer> getNumberOfDocuments();
	...
	/**
	 * Returns the value of the TextDictionary child.
	 * @return the value of the TextDictionary child.
	 */
	@NotNull
	@Required
	...
	/**
	 * Returns the value of the TextCorpus child.
	 * @return the value of the TextCorpus child.
	 */
	@NotNull
	@Required
	...
	/**
	 * Returns the value of the DocumentTermMatrix child.
	 * @return the value of the DocumentTermMatrix child.
	 */
	@NotNull
	@Required
	...
	/**
	 * Returns the value of the TextModelNormalization child.
	 * @return the value of the TextModelNormalization child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the TextModelSimiliarity child.
	 * @return the value of the TextModelSimiliarity child.
	 */
	@NotNull
