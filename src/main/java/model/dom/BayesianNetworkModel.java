...
/**
 * http://www.dmg.org/PMML-4_3:BayesianNetworkModelElemType interface.
 */
public interface BayesianNetworkModel extends DomElement {
	...
	/**
	 * Returns the value of the BayesianNetworkNodes child.
	 * @return the value of the BayesianNetworkNodes child.
	 */
	@NotNull
	@Required
	BayesianNetworkNodes getBayesianNetworkNodes();
