...
/**
 * http://www.dmg.org/PMML-4_3:NaiveBayesModelElemType interface.
 */
public interface NaiveBayesModel extends DomElement {
	...
	/**
	 * Returns the value of the BayesInputs child.
	 * @return the value of the BayesInputs child.
	 */
	@NotNull
	@Required
	...
	/**
	 * Returns the value of the BayesOutput child.
	 * @return the value of the BayesOutput child.
	 */
	@NotNull
	@Required
	BayesOutput getBayesOutput();
