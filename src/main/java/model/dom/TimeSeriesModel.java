...
/**
 * http://www.dmg.org/PMML-4_3:TimeSeriesModelElemType interface.
 */
public interface TimeSeriesModel extends DomElement {
	...
	/**
	 * Returns the value of the bestFit child.
	 * @return the value of the bestFit child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<TIMESERIESALGORITHM> getBestFit();
	...
	/**
	 * Returns the list of TimeSeries children.
	 * @return the list of TimeSeries children.
	 */
	@NotNull
	java.util.List<TimeSeries> getTimeSerieses();
	/**
	 * Adds new child to the list of TimeSeries children.
	 * @return created child
	 */
	...
	/**
	 * Returns the value of the SpectralAnalysis child.
	 * @return the value of the SpectralAnalysis child.
	 */
	@NotNull
	GenericDomValue<String> getSpectralAnalysis();


	/**
	 * Returns the value of the ARIMA child.
	 * @return the value of the ARIMA child.
	 */
	@NotNull
	GenericDomValue<String> getARIMA();


	/**
	 * Returns the value of the ExponentialSmoothing child.
	 * @return the value of the ExponentialSmoothing child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the SeasonalTrendDecomposition child.
	 * @return the value of the SeasonalTrendDecomposition child.
	 */
	@NotNull
	GenericDomValue<String> getSeasonalTrendDecomposition();
