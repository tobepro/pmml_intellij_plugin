...
/**
 * http://www.dmg.org/PMML-4_3:RegressionModelElemType interface.
 */
public interface RegressionModel extends DomElement {
	...
	/**
	 * Returns the value of the targetFieldName child.
	 * @return the value of the targetFieldName child.
	 */
	@NotNull
	GenericAttributeValue<String> getTargetFieldName();
	 ...
	 */
	@NotNull
	GenericAttributeValue<REGRESSIONNORMALIZATIONMETHOD> getNormalizationMethod();
	...
	/**
	 * Returns the list of RegressionTable children.
	 * @return the list of RegressionTable children.
	 */
	@NotNull
	@Required
	java.util.List<RegressionTable> getRegressionTables();
	/**
	 * Adds new child to the list of RegressionTable children.
	 * @return created child
	 */
	RegressionTable addRegressionTable();
